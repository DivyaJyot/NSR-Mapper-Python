...
class ErricssonOCsiparser:
    ...
    def generateInputJson(self):
        try:
            ...
            csvFile=_input_directory_+"Ocsi.csv"
...
if __name__ == '__main__':
    _index_csv_=config.project_path + '/log/ericsson/ocsi/ocsi.csv'
    file_name="D:/userdata/djyoti/Desktop/2018/SDM/Code/svn/OCSILatest/tool/inputFiles/ericsson/OCSi_Dump.txt"
    
    ocsiparser= ErricssonOCsiparser(file_name)
    inputJson=ocsiparser.generateInputJson()
    print(inputJson)
